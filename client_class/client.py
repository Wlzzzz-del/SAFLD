...
class client():
    def __init__(self, cid,  model, lr, steps,data,batch_size, dev ,test_data):
        ...
        # self.model = SimpleCNN(input_size=3, hidden_size=[256,128,64,32],classes_size=10)
        # self.model = CIFARcnn()
        self.model = model
